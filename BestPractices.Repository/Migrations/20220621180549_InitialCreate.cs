    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 6, 21, 21, 5, 49, 677, DateTimeKind.Local).AddTicks(1870), "Kalem 1", 100m, 0, 200, null },
                    { 2, 1, new DateTime(2022, 6, 21, 21, 5, 49, 677, DateTimeKind.Local).AddTicks(1940), "Kalem 2", 200m, 0, 30, null },
                    { 3, 2, new DateTime(2022, 6, 21, 21, 5, 49, 677, DateTimeKind.Local).AddTicks(1940), "Kitaplar 1", 20m, 0, 40, null },
                    { 4, 3, new DateTime(2022, 6, 21, 21, 5, 49, 677, DateTimeKind.Local).AddTicks(1940), "Defterler 1", 20m, 0, 40, null }
                });

            migrationBuilder.InsertData(
                table: "ProductFeatures",
                columns: new[] { "Id", "Color", "CreatedDate", "Height", "ProductId", "UpdatedDate", "Width" },
                values: new object[] { 2, "Mavi", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 50, 1, null, 200 });
